...
const SPECTRUM_FILTER_ITERATIONS = 5
...
const W_λ_UNC_THRESHOLD = 12.5 # %
#const MONTE_CARLO_NUM_SAMPLES = 30_000
const CURVE_OF_GROWTH_SIGMACLIP = 2
const GRID_TEFF_UNC = 250 # K
const GRID_LOGG_UNC = 0.5 # cm/s²
const GRID_FEH_UNC = 0.25 # dex
const GRID_α_FE_UNC = 0.1 # dex